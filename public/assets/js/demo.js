...
$.notify({
	icon: 'icon-bell',
	title: 'Gestdechet',
	message: 'Meilleure solution pour la gestion des dechets',
},{
	type: 'secondary',
	placement: {
		from: "bottom",
...
var world_map = new jsVectorMap({
	selector: "#world-map", // Utilisez le même id que vous avez défini dans votre HTML
	map: "world", // Sélectionne spécifiquement la carte du Mali
	zoomOnScroll: false,
	regionStyle: {
		hover: {
			fill: '#435ebe'
...
// 			fill: true,
// 			borderWidth: 2,
// 			data: [51, 40, 30, 50, 53, 43, 80, 34, 68, 10, 70, 0]
// 		}]
// 	},
// 	options : {
// 		responsive: true, 
