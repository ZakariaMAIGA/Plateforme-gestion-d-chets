            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('entreprise.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="nom_resident">Nom entreprise</label>
                                                <input type="text" class="form-control" name="nom_entreprise" value="{{ $compte->entreprise->nom_entreprise }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="prenom_resident">Service</label>
                                                <input type="text" class="form-control" name="service" value="{{ $compte->entreprise->service }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
