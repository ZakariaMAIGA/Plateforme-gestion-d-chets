                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nom" value="{{ $compte->admin->nom }}" required>
                                            </div>
                                             @error("nom")
                                     ...
                                     @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="prenom" value="{{ $compte->admin->prenom }}" required>
                                            </div>
                                             @error("prenom")
                                      <li class="alert alert-danger">  {{$message}} </li>
                                     @enderror
